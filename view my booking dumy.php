...
// SQL query to fetch booking details, hall name from halls table, and user details
$sql = "SELECT 
            hb.booking_id, 
            h.hall_name, 
            hb.organizer_name, 
        ...
        <form id="batchDownloadForm" method="post" action="batch_download.php">
            <table id="bookingsTable">
                ...
                <tr class="booking-row <?php echo $is_new ? 'new-booking' : ''; ?>" data-status="<?php echo $row['status']; ?>">
                    ...
                    <td>
                        <a href="download_booking_pdf.php?id=<?php echo $row['booking_id']; ?>" class="download-btn">
                            <i class="fas fa-download"></i> Download
                        </a>
                        
                        <?php if ($row['status'] == 'Pending'): ?>
                        <a href="cancel_booking.php?id=<?php echo $row['booking_id']; ?>" class="cancel-btn" onclick="return confirm('Are you sure you want to cancel this booking?')">
